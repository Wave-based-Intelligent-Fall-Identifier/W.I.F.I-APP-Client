package com.example.wify_app_android.notification
...
import com.example.wify_app_android.MainActivity
import com.example.wify_app_android.R

/**
 * 낙상(의심/확정) 등 기기 이벤트를 **시스템 알림**으로 사용자에게 알리는 계약.
 *
 * MQTT 수신 → [com.example.wify_app_android.transport.DeviceEventBridge] → (Repository 반영 + 이 알림).
...
class AndroidWifyNotifier(
    ...
    companion object {
        ...
        const val EXTRA_DEVICE_ID = "com.example.wify_app_android.extra.DEVICE_ID"
